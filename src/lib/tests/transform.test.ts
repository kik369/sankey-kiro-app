...
describe('Data Transformation Functions', () => {
  ...
  describe('transformFlowsToSankeyData', () => {
    ...
    it('should handle null/undefined flows', () => {
      const sankeyData1 = transformFlowsToSankeyData(null as any);
      const sankeyData2 = transformFlowsToSankeyData(undefined as any);

      expect(sankeyData1).toEqual({ nodes: [], links: [] });
      expect(sankeyData2).toEqual({ nodes: [], links: [] });
    });
