        ...
        >
            ...
            <div class="space-y-2 sm:col-span-2 lg:col-span-1">
                ...
                <button
                    ...
                    class="w-full btn btn-primary disabled:bg-gray-400 disabled:cursor-not-allowed text-base sm:text-sm"
                >
        ...
        {#if showValidation && (validationResult.errors.length > 0 || (validationResult.warnings && validationResult.warnings.length > 0))}
            <div class="mt-4 space-y-3">
                ...
                {#if validationResult.errors.length > 0}
                    <div class="alert alert-error bg-white dark:bg-gray-800">
                        <div class="flex">
                ...
                {#if validationResult.warnings && validationResult.warnings.length > 0}
                    <div class="alert alert-warning bg-white dark:bg-gray-800">
                        <div class="flex">
                            <div class="flex-shrink-0">
                                <svg
        ...
        >
            ...
            <div class="space-y-3">
                {#each flows as flow (flow.id)}
                    <div
                        class="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 bg-gray-50/50 dark:bg-gray-700/50 rounded-md border border-gray-200 dark:border-gray-600 gap-3"
                    >
                        <div
                        ...
                        <button
                            ...
                            class="self-start sm:self-auto sm:ml-4 p-2 text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300
                     hover:bg-red-50/60 dark:hover:bg-red-900/20 rounded-md transition-colors duration-200 flex items-center gap-2"
                            title="Remove flow"
